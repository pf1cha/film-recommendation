...
class TestRegistrationWindow(unittest.TestCase):
    def registration_window_title_is_correct(self):
        registration_window = RegistrationWindow()
        self.assertEqual(registration_window.windowTitle(), "Register")

    def registration_window_geometry_is_correct(self):
        registration_window = RegistrationWindow()
        self.assertEqual(registration_window.geometry().getRect(), (350, 350, 300, 200))

    def register_user_with_valid_data_shows_success_message(self):
        registration_window = RegistrationWindow()
    ...
    def register_user_with_empty_fields_shows_error_message(self):
        registration_window = RegistrationWindow()
    ...
    def register_user_with_existing_username_shows_error_message(self):
        registration_window = RegistrationWindow()
